...
namespace Boss
{
    ...
    public class BossBase : MonoBehaviour, IDamageable
    {
        ...
        public Ease startAnimatiionEase = Ease.OutBack;
        ...
        #region ANIMATION
            ...
            {
                transform.DOScale(0, startAnimationDuration).SetEase(startAnimatiionEase).From().OnComplete(() => { onComplete?.Invoke(); });
            }
